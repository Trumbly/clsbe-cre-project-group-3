...
runtime by ``qualtrics/javascript/inject-composition-image.js`` from the
Composition field. This keeps the L&M grid to 7 columns and avoids
redundant per-row URL storage.
"""
